  ...
  return (
    <div className="bg-orange-50 min-h-screen font-inter">
      ...
      <div className="flex flex-row">
        ...
        <main className="flex-1 px-6 pb-24 mt-8">
          <h2 className="text-3xl font-bold text-black text-center mb-4">Perfil</h2>
          <div className="flex justify-center mb-4">
            <div className="relative">
              <img src="/user.svg" alt="Ícono usuario predeterminado" className="w-24 h-24 text-black" />
              <button className="absolute bottom-0 right-0 bg-surface text-black text-xs font-semibold 
                                  rounded-md px-2 py-1 border border-black text-center cursor-pointer">
                Cambiar Foto
              </button>
            </div>
          </div>
          <div className="space-y-4">
            ...
            <div className="border border-black rounded-lg p-3">
              ...
              <button className="mt-4 w-full bg-surface text-black 
                                  font-semibold rounded-lg py-2 border border-black text-sm cursor-pointer">
                Agregar Idioma
              </button>
            </div>
            ...
            <div className="pt-4 text-center">
              <button className="w-full bg-surface text-black font-bold rounded-lg py-3 
